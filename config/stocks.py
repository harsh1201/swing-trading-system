...
STOCKS: dict[str, str] = {
    ...
    "LAXMICHEM.NS":   "Laxmi Organic",
    "CLEAN.NS":       "Clean Science",
    "LINDEINDIA.NS":  "Linde India",
    "VINATI.NS":      "Vinati Organics",
    "NOCIL.NS":       "NOCIL",
    ...
    "TATVACC.NS":     "Tatva Chintan Pharma",
